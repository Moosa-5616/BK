...
class BridgeKeeper:
    ...
    def initialize_village(self):
        ...
        for i in range(15):
            ...
            elements.append({
                ...
                'x': x, 'y': y,
                'width': 40, 'height': 40,
                'resources': {'wood': 8, 'metal': 3},
                'villagers': random.randint(2, 5),
                'dismantled': False,
                'description': f"Family home ({random.randint(2, 5)} residents)"
            })
        ...
        for i in range(10):
            ...
            elements.append({
                ...
                'x': x, 'y': y,
                'width': 30, 'height': 25,
                'resources': {'stone': 4, 'metal': 2},
                'villagers': 0,
                'dismantled': False,
                'description': f"Village {infra_type}"
            })
        ...
        for element in self.village_elements:
            if not element['dismantled']:
                ...
                if element_bottom > flood_y and element not in self.submerged_elements:
                    self.submerged_elements.add(element)
    ...
    def draw_character(self):
        ...
        if char['direction'] == 'down':
            character_sprite = [
                ['', '', '', '', '', '', 'earth_brown', 'earth_brown', 'earth_brown', 'earth_brown', 'earth_brown', 'earth_brown', 'earth_brown', 'earth_brown', '', '', '', '', '', ''],
                ['', '', '', '', '', 'earth_brown', 'earth_brown', 'earth_brown', 'earth_brown', 'earth_brown', 'earth_brown', 'earth_brown', 'earth_brown', 'earth_brown', 'earth_brown', '', '', '', '', ''],
                ['', '', '', '', 'earth_brown', 'earth_brown', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_brown', 'earth_brown', '', '', '', ''],
                ['', '', '', 'earth_brown', 'earth_brown', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_brown', 'earth_brown', '', '', ''],
                ['', '', 'earth_brown', 'earth_brown', 'earth_light', 'earth_light', 'earth_light', 'black', 'black', 'earth_light', 'earth_light', 'black', 'black', 'earth_light', 'earth_light', 'earth_light', 'earth_brown', 'earth_brown', '', ''],
                ['', 'earth_brown', 'earth_brown', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'black', 'white', 'earth_light', 'earth_light', 'black', 'white', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_brown', 'earth_brown', ''],
                ['earth_brown', 'earth_brown', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'flood_red', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'flood_red', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_brown', 'earth_brown'],
                ['earth_brown', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'black', 'black', 'black', 'black', 'black', 'black', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_brown'],
                ['earth_brown', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_brown'],
                ['', 'earth_brown', 'earth_brown', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_brown', 'earth_brown', ''],
                ['', '', 'earth_brown', 'earth_brown', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_light', 'earth_brown', 'earth_brown', '', ''],
                ['', '', '', 'earth_brown', 'earth_brown', 'earth_brown', 'forest_green', 'forest_green', 'forest_green', 'forest_green', 'forest_green', 'forest_green', 'forest_green', 'forest_green', 'earth_brown', 'earth_brown', 'earth_brown', '', '', ''],
                ['', '', '', '', 'earth_brown', 'forest_green', 'forest_green', 'forest_light', 'forest_green', 'forest_green', 'forest_green', 'forest_green', 'forest_light', 'forest_green', 'forest_green', 'earth_brown', '', '', '', ''],
                ['', '', '', '', '', 'forest_green', 'forest_green', 'forest_green', 'forest_green', 'forest_green', 'forest_green', 'forest_green', 'forest_green', 'forest_green', 'forest_green', '', '', '', '', ''],
                ['', '', '', '', '', 'forest_green', 'forest_green', 'forest_green', 'forest_green', 'forest_green', 'forest_green', 'forest_green', 'forest_green', 'forest_green', 'forest_green', '', '', '', '', ''],
                ['', '', '', '', '', 'forest_green', 'forest_green', 'forest_green', 'forest_green', 'forest_green', 'forest_green', 'forest_green', 'forest_green', 'forest_green', 'forest_green', '', '', '', '', ''],
                ['', '', '', '', '', 'earth_brown', 'earth_brown', 'forest_green', 'forest_green', 'forest_green', 'forest_green', 'forest_green', 'forest_green', 'earth_brown', 'earth_brown', '', '', '', '', ''],
                ['', '', '', '', '', 'earth_brown', 'earth_brown', 'forest_green', 'forest_green', 'forest_green', 'forest_green', 'forest_green', 'forest_green', 'earth_brown', 'earth_brown', '', '', '', '', ''],
                ['', '', '', '', 'earth_brown', 'earth_brown', 'earth_brown', 'earth_brown', 'earth_brown', '', '', 'earth_brown', 'earth_brown', 'earth_brown', 'earth_brown', 'earth_brown', '', '', '', ''],
                ['', '', '', 'earth_brown', 'earth_brown', 'earth_brown', 'earth_brown', 'earth_brown', '', '', '', '', 'earth_brown', 'earth_brown', 'earth_brown', 'earth_brown', 'earth_brown', '', '', ''],
                ['', '', 'earth_brown', 'earth_brown', 'earth_brown', 'earth_brown', 'earth_brown', '', '', '', '', '', '', 'earth_brown', 'earth_brown', 'earth_brown', 'earth_brown', 'earth_brown', '', ''],
    ...
    def draw_game_over(self):
        ...
        # Detailed statistics
        stats = [
            f"Villagers Saved: {self.villagers_saved}/{self.initial_villagers} ({int(survival_rate*100)}%)",
        ...
        if self.achievements:
            ...
            achievement_rect = achievement_title.get_rect(center=(SCREEN_WIDTH//2, y_start + len(stats) * 25 + 30))
        ...
        restart_y = y_start + len(stats) * 25 + 60 + len(self.achievements) * 20 + 40
